...
<html>
    ...
    <body>
        ...
        <form id="AreaVenditore" action="venditore.html" method="POST">
                    ...
                    <textarea rows='5' cols='20' name='url' id='url'></textarea>
                    ...
                    <input name="SubmitMod" type="submit" value="Modifica Oggetto">
                    <input name="SubmitDel" type="submit" value="Elimina Oggetto">
            </form>
        </div>
    </body>
</html>
